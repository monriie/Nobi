  ...
  return (
    ...
    >
      ...
      >
        ...
        <li>
          <Link onClick={scrollToTop} to="/" className="px-4 py-2 text-lg font-medium">
            Home
          </Link>
        </li>
        <li>
          <Link onClick={scrollToTop} to="/movies" className="px-4 py-2 text-lg font-medium">
            Movies
          </Link>
        </li>
        <li>
          <Link onClick={scrollToTop} to="/theaters" className="px-4 py-2 text-lg font-medium">
            Theaters
          </Link>
        </li>
        <li>
          <Link onClick={scrollToTop} to="/releases" className="px-4 py-2 text-lg font-medium">
            Releases
          </Link>
        </li>
        <li>
          <Link onClick={scrollToTop} to="/favorite" className="px-4 py-2 text-lg font-medium">
            Favorites
          </Link>
        </li>
      </ul>
